...
// Handle both left and right clicks for selection
...
function onPointerUpPan(e) {
    ...
    // Only treat as click if total movement was very small
    if (totalDragMovement <= 2) {
        onPointer(e);
    } 
    // Apply inertia if we were actually dragging
    else if (dragMoved && Math.abs(lastDragDx) > 0) {
